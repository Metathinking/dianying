...
//        createMapper(TuiGuangRecord.class,directoryPath, Arrays.asList(INSERT,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
//        createMapper(LingQuMa.class,directoryPath, Arrays.asList(INSERT,UPDATE,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
        createMapper(LingQuRecord.class,directoryPath, Arrays.asList(INSERT,GET_MAX_ID,FIND_BY_ID));
    ...
    private static String testDirectoryPath = "D:" + File.separator + "workspace" + File.separator + "dianying" + File.separator + "src" + File.separator + "test" + File.separator
            + "resources" + File.separator + "mapper";
    private static String directoryPath = "D:" + File.separator + "workspace" + File.separator + "dianying" + File.separator + "src" + File.separator + "main" + File.separator
            + "resources" + File.separator + "mapper";
